...
<div class="max-w-5xl mx-auto pb-20 px-4 sm:px-6">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div class="flex items-center gap-5 px-6 py-5 bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40">
            <div class="relative group">
                <div class="w-16 h-16 rounded-2xl bg-slate-900 flex items-center justify-center text-white shadow-lg transition-transform group-hover:rotate-3">
            ...
            <div>
                <p class="text-base font-black text-slate-900 leading-tight">{{ auth()->user()->name }}</p>
                <div class="flex flex-wrap items-center gap-2 mt-1.5">
                    ...
                    <span class="text-[10px] font-bold text-slate-400 tracking-widest uppercase bg-slate-50 px-2 py-0.5 rounded-md">
